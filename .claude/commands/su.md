...
- List the changes as simply as possible. One line each where possible.
- No explanations, no rationale, no code, no diffs.
- Include side effects or other changes that may also be required. Only when real.
- Open questions go at the bottom. Only if genuinely unresolved and relevant.
